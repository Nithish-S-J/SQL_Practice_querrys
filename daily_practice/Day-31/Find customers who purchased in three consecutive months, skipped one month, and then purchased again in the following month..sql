----Find customers who purchased in three consecutive months, skipped one month, 
----and then purchased again in the following month.
...
select distinct
       ...
       (select *,
               ...
               select *
                      ...
                      and datediff(month, lead1, lead2) = 1 
                      and datediff(month, lead2, lead3) = 2
