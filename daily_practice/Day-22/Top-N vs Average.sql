---Find categories where the Top 5 products contribute more
--sales than the category's average product sales multiplied by 20.
...
select dp.category,
       ...
       (select category,
               ...
               (select category,
                       ...
                       where top5sales > 20*avgcategorysales
