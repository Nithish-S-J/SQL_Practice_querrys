--Find customers who purchased in a month and also purchased in the immediately following month.
---Output: customer_id, customer_name, purchase_month, next_purchase_month
...
select 
       ...
       (select *,
               ...
               select customer_id,
                      ...
                      where datediff(month, purchase_month, next_purchase_month) = 1
